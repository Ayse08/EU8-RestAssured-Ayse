...
public class ORDSApiWithJsonPath extends HRTestBase {
    ...
    public void test1(){
        ...
        String secondCoutryName = jsonPath.getString("items[1].country_name");
        System.out.println("secondCoutryName = " + secondCoutryName);
        ...
        List<String> countryNameWithRegionId2 = jsonPath.getList("items.findAll {it.regions_id==2}.country_name");
